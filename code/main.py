from base_method import LineSegmentation
...
if __name__ == "__main__":
    # Этот кусок показывает ка кразмечено всё в датасете
    ...
    # print('img_id', img_id)
    # category_id = 0
    # mask = generator.create_binary_mask('/home/sasha/Documents/CourseMIPT/MyFirstScientificWork/library/datasets/school_notebooks_RU/images_base/1_10.JPG', img_id)
    ...
    #     generator.visualize('datasets/school_notebooks_RU/images/0_0.jpg', img_id, category_id=category_id, show_bbox=False)
